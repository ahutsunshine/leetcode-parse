...
public class ImageUtil {
    ...
    private static HttpUriRequest buildRequest(String uri, String refer,
                                                String cookie, HttpEntity params) {
    ...
    public static APIResponse upload(String uri, String refer, String cookie, MultipartFile file) throws IOException {
        HttpEntity formData = buildImageFormData(file);
        HttpUriRequest request = buildRequest(uri, refer, cookie, formData);
