...
public class ImageUtil {
    ...
    public static APIResponse upload(String uri, String refer, String token, String cookie, MultipartFile file) throws IOException {
        HttpEntity formData = buildImageFormData(file);
        HttpUriRequest request = buildRequest(uri, refer, token, cookie, formData);
